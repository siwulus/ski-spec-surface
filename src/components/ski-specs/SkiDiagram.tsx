...
interface SkiDiagramProps {
  spec: SkiSpecDTO;
}

/**
 * Visual ski diagram showing dimensions and measurements.
 * Reusable component displaying tip/waist/tail widths, length, radius, and weight.
 */
export const SkiDiagram: React.FC<SkiDiagramProps> = ({ spec }) => {
  return (
